...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("F:\\mygit\\reposiry1\\myMicroserviceProject\\MicroserviceProject\\guns-rest\\src\\main\\java");//这里写你自己的java目录
        ...
        pc.setService("com.stylefeng.guns.rest.modular.rest.service");       //本项目没用，生成之后删掉
        pc.setServiceImpl("com.stylefeng.guns.rest.modular.rest.service.impl");   //本项目没用，生成之后删掉
        pc.setController("com.stylefeng.guns.rest.modular.rest.controller");    //本项目没用，生成之后删掉
