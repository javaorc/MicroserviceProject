...
public class MoocOrderT extends Model<MoocOrderT> {
    ...
    public MoocOrderT(String uuid, Integer cinemaId, Integer fieldId, Integer filmId, String seatsIds, String seatsName, Double filmPrice, Double orderPrice, Date orderTime, Integer orderUser, Integer orderStatus) {
        this.uuid = uuid;
        this.cinemaId = cinemaId;
        this.fieldId = fieldId;
        this.filmId = filmId;
